    ...
    <div class="relative flex h-16 justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <NuxtLink to="/" class="font-extrabold text-gray-900 text-3xl">
            C
          </NuxtLink>
        </div>
        <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
          <!-- <a href="#" class="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-900">Dashboard</a> -->
          <NuxtLink to="/" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Combinaisons</NuxtLink>
          <NuxtLink to="favories" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Combinaisons favorites</NuxtLink>
          <NuxtLink to="palette" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">Générateur de palette</NuxtLink>
        </div>
      </div>
